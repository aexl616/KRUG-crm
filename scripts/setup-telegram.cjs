...
(async()=>{
 ...
 console.log('Telegram webhook and commands configured. No client messages sent.');
})().catch(()=>{console.error('Telegram setup failed. Check environment values and bot connectivity; secrets are omitted.');process.exitCode=1;});
